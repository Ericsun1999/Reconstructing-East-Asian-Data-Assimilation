...
6. `Figure6e.R` uses the REACHES data (`Data/temperature index value.v1.xlsx`) and the LME data (`Data/LME data/Figure9`) to produce Figure 6(e). (It should be executed after running Figure4.R)
