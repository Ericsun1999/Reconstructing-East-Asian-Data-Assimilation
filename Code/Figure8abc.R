...
#Figure8a, Time series plot of the estimated parameter M_t from years 1368 to 1911
...
#Figure8b, Time series plot of the estimated parameter µ_t from years 1368 to 1911
 ...
 #Figure8b, Time series plot of the estimated parameter r_t^2 from years 1368 to 1911      
